        ...
        LagBrevinnholdForBeregning(beregning).brevInnhold shouldBe listOf(
            Beregningsperiode(
                ...
                fradrag = Fradrag(
                    bruker = listOf(
                        Månedsfradrag(
                            type = FradragskategoriWrapper(Fradragskategori.ForventetInntekt).toReadableTypeName(
                                utenlandsk = false,
                            ),
                            beløp = 1000,
                            utenlandskInntekt = null,
        ...
        LagBrevinnholdForBeregning(beregning).brevInnhold shouldBe listOf(
            ...
            Beregningsperiode(
                ...
                fradrag = Fradrag(
                    bruker = listOf(
                        Månedsfradrag(
                            type = FradragskategoriWrapper(Fradragskategori.Arbeidsinntekt).toReadableTypeName(
                                utenlandsk = false,
                            ),
                            beløp = 9999,
                            utenlandskInntekt = null,
                        ...
                        Månedsfradrag(
                            type = FradragskategoriWrapper(Fradragskategori.Sosialstønad).toReadableTypeName(
                                utenlandsk = false,
                            ),
                            beløp = 2000,
                            utenlandskInntekt = null,
                ...
                fradrag = Fradrag(
                    ...
                    eps = Fradrag.Eps(
                        listOf(
                            ...
                            Månedsfradrag(
                                type = FradragskategoriWrapper(Fradragskategori.Kapitalinntekt).toReadableTypeName(
                                    utenlandsk = false,
                                ),
                                beløp = 1000,
                                utenlandskInntekt = null,
    ...
    fun `jsonformat på beregning stemmer overens med det som forventes av pdfgenerator`() {
        val beregning = Beregningsperiode(
            ...
            fradrag = Fradrag(
                bruker = listOf(
                    Månedsfradrag(
                        type = FradragskategoriWrapper(Fradragskategori.Arbeidsinntekt).toReadableTypeName(utenlandsk = false),
                        beløp = 10,
                        utenlandskInntekt = null,
                    ),
                    Månedsfradrag(
                        type = FradragskategoriWrapper(Fradragskategori.OffentligPensjon).toReadableTypeName(utenlandsk = false),
                        beløp = 35,
                        utenlandskInntekt = null,
                    ),
                    Månedsfradrag(
                        type = FradragskategoriWrapper(Fradragskategori.OffentligPensjon).toReadableTypeName(utenlandsk = true),
                        beløp = 70,
    ...
    fun `Fradrag for eps er tom liste hvis beløp er lavere enn fribeløp`() {
        val beregning = BeregningFactory(clock = fixedClock).ny(
            fradrag = listOf(
                ...
                FradragFactory.ny(
                    fradragskategoriWrapper = FradragskategoriWrapper(Fradragskategori.Introduksjonsstønad),
                    månedsbeløp = 3000.0,
                    periode = Periode.create(fraOgMed = 1.mai(2020), tilOgMed = 30.april(2021)),
                    utenlandskInntekt = null,
                    tilhører = FradragTilhører.EPS,
            ...
            Beregningsperiode(
                ...
                fradrag = Fradrag(
                    ...
                    eps = Fradrag.Eps(
                        listOf(
                            Månedsfradrag(
                                type = FradragskategoriWrapper(Fradragskategori.BidragEtterEkteskapsloven).toReadableTypeName(
                                    utenlandsk = false,
                                ),
                                beløp = 6000,
                                utenlandskInntekt = null,
                            ...
                            Månedsfradrag(
                                type = FradragskategoriWrapper(Fradragskategori.Introduksjonsstønad).toReadableTypeName(
                                    utenlandsk = false,
                                ),
                                beløp = 6000,
                                utenlandskInntekt = null,
                            ...
                            Månedsfradrag(
                                type = FradragskategoriWrapper(Fradragskategori.Kontantstøtte).toReadableTypeName(
                                    utenlandsk = false,
                                ),
                                beløp = 6000,
                                utenlandskInntekt = null,
