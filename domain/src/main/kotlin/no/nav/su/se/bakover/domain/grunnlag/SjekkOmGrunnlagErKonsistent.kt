...
data class SjekkOmGrunnlagErKonsistent(
    ...
    private val bosituasjongrunnlag: List<vilkår.bosituasjon.domain.grunnlag.Bosituasjon.Fullstendig>,
    ...
    data class Bosituasjon(
        val bosituasjon: List<vilkår.bosituasjon.domain.grunnlag.Bosituasjon>,
    ) {
        val resultat: Either<Set<Konsistensproblem.Bosituasjon>, Unit> = bosituasjon(bosituasjon)

        private fun bosituasjon(bosituasjon: List<vilkår.bosituasjon.domain.grunnlag.Bosituasjon>): Either<Set<Konsistensproblem.Bosituasjon>, Unit> {
            mutableSetOf<Konsistensproblem.Bosituasjon>().apply {
                if (bosituasjon.isEmpty()) {
                    add(Konsistensproblem.Bosituasjon.Mangler)
                }
                if (bosituasjon.any { it is vilkår.bosituasjon.domain.grunnlag.Bosituasjon.Ufullstendig }) {
