...
fun Merknad.Beregning.tilAvslagsgrunn(): AvslagGrunnetBeregning.Grunn {
    return when (this) {
        ...
        Merknad.Beregning.BeløpMellomNullOgToProsentAvHøySats -> AvslagGrunnetBeregning.Grunn.SU_UNDER_MINSTEGRENSE
        else -> throw IllegalStateException("Ukjent merknad for avslag: ${this::class}")
    }
}
