...
import no.nav.su.se.bakover.domain.behandling.avslag.Avslagsgrunn.FLYKTNING
...
internal object TestBeregning : Beregning {
    ...
    override fun utledAvslagsgrunner(): List<Avslagsgrunn> = listOf(FLYKTNING)
}
