...
import no.nav.su.se.bakover.domain.søknad.Søknad.Journalført.MedOppgave.Lukket.LukketType.AVVIST
import no.nav.su.se.bakover.domain.søknad.Søknad.Journalført.MedOppgave.Lukket.LukketType.TRUKKET
...
internal class LukkSøknadServiceImplTest {
    ...
    fun `trekker en søknad uten mangler`() {
        ...
        val sakServiceMock = mock<SakService> {
            ...
            on { hentSakidOgSaksnummer(any()) } doReturn SakIdOgNummer(
                sakId = sak.id,
