...
Rekkefølge i BQ:
       ...
       "underminsteniva", "underminstenivaeps", "annet", "anneteps", "omsorgsloenn", "omsorgsloenneps", "lastetdato"
 */
        ...
        for (dto in this@toCSV) {
            appendLine(
                listOf(
                    ...
                    dto.omsorgslønn?.toString().orEmpty(),
                    dto.omsorgslønnEps?.toString().orEmpty(),
