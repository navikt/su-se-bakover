...
interface StønadStatistikkJobService {
    ...
    fun lagStatistikkForFlereMåneder(fraOgMed: YearMonth, tilOgMed: YearMonth)
...
class StønadStatistikkJobServiceImpl(
    ...
    private fun toStønadstatistikk(
        ...
        return StønadstatistikkMåned(
            ...
            omsorgslønn = fradragOmFinnes(
                Fradragstype.Kategori.Omsorgslønn,
                FradragTilhører.BRUKER,
                månedsbeløp,
            ),
            omsorgslønnEps = fradragOmFinnes(
                Fradragstype.Kategori.Omsorgslønn,
                FradragTilhører.EPS,
                månedsbeløp,
            ),
