...
interface VedtakService {
    ...
    fun hentGjeldendeGrunnlagsdataForVedtak(sakId: UUID, vedtakId: UUID): Either<KunneIkkeHenteGjeldendeGrunnlagsdataForVedtak, GjeldendeVedtaksdata>
}
...
sealed class KunneIkkeHenteGjeldendeGrunnlagsdataForVedtak {
    ...
    object FantIngenVedtak : KunneIkkeHenteGjeldendeGrunnlagsdataForVedtak()
}
