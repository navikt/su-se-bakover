...
internal class StatistikkSøknadsbehandlingTest {
    ...
    fun `publiserer opprettet søknadsbehandling`() {
        ...
        assert(
            statistikkEvent = StatistikkEvent.Behandling.Søknad.Opprettet(
                søknadsbehandling,
                NavIdentBruker.Saksbehandler("saksbehandlerSomOpprettet"),
            ),
    ...
    fun `publiserer innvilget søknadsbehandling til attestering`() {
        ...
        assert(
            ...
            funksjonellTid = søknadsbehandling.attesteringer.toFunksjonellTid(søknadsbehandling.id, fixedClock),
        )
    }
    ...
    fun `publiserer lukket søknadsbehandling`() {
        ...
        assert(
            ...
            resultat = "Trukket",
            resultatBeskrivelse = "Spesifisering av [Avbrutt]. Bruker eller verge/fullmakt har bedt om å trekke søknad/klage.",
