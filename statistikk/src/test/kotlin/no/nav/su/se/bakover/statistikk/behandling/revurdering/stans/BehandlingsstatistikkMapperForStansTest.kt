...
internal class BehandlingsstatistikkMapperForStansTest {
    ...
    fun `simulert stans`() {
        ...
        assert(
            ...
            resultat = "Stans",
            resultatBeskrivelse = "Stønadsendring som fører til stans av utbetalingen(e) for en gitt måned og framover. Det motsatte av resultatet [Gjenopptatt].",
