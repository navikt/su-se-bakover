...
I `su-se-bakover` er arketypen allerede kjent: en etablert Kotlin/Ktor-backend.
Still bare spørsmål som ikke kan besvares fra repoet. Ikke gjør hele intervjuet
obligatorisk for små endringer; bruk det ved nye dataflyter, auth, personvern,
integrasjoner eller større arkitekturvalg.
...
> - Ktor-endepunkt eller application/domain-endring
> - Kafka- eller MQ-integrasjon etter eksisterende klientmønster
...
- [ ] Er eksisterende pool-størrelse vurdert mot replicas og databasegrense?
