...
internal class Ok(val json: String) : Result() {
    override fun equals(other: Any?): Boolean = other is Ok && other.json.equals(this.json)
...
internal class Feil(val httpCode: Int, val message: String) : Result() {
    ...
    override fun equals(other: Any?) =
        other is Feil && other.httpCode == this.httpCode && other.message.equals(this.message)
