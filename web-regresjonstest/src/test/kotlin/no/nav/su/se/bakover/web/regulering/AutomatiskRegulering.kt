...
fun verifyManuellReguleringMedSupplement(
    ...
    val expected = """{
        ...
        "opprettet":"2021-05-21T01:02:03.456789Z",
        "årsakForManuell":[{"begrunnelse":"Vi fant et supplement for BRUKER, men ikke for Alderspensjon.","fradragTilhører":"BRUKER","fradragstype":"Alderspensjon"}],
        "sakstype":"uføre",
...
fun verifyReguleringFørEttersendelse(
    ...
    val expected = """{
        ...
        "reguleringstype":"MANUELL",
        "reguleringsstatus":"OPPRETTET",
        "årsakForManuell":[{"begrunnelse":"Fradraget til BRUKER: Alderspensjon påvirkes av samme sats/G-verdi endring som SU. Vi mangler supplement for dette fradraget og derfor går det til manuell regulering.","fradragTilhører":"BRUKER","fradragstype":"Alderspensjon"}],
        "periode":{"fraOgMed":"2021-05-01","tilOgMed":"2021-12-31"},
