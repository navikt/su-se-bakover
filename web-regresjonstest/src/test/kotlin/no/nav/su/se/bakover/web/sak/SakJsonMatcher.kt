...
fun assertSakJson(
    ...
    expectedHarInnvilgetStønadsperiode: Boolean = false,
) {
    // language=JSON
    val expectedSakJson = """
    {
        ...
        "harInnvilgetStønadsperiode": $expectedHarInnvilgetStønadsperiode
    }
    """.trimIndent()
    jsonAssertEquals(
        ...
        "behandlinger[*].id",
        "behandlinger[*].sakId",
        "behandlinger[*].søknad.id",
        "behandlinger[*].søknad.sakId",
        "utbetalinger[*].sakId",
        "vedtak[*].id",
        "vedtak[*].opprettet",
        "vedtak[*].utbetalingId",
