...
fun digitalSøknadsinnholdAlderJson(
    brukerFnr: String,
    epsFnr: String,
): String {
    return søknadsinnholdAlderJson(brukerFnr = brukerFnr, epsFnr = epsFnr)
}

fun søknadsinnholdAlderJson(brukerFnr: String, epsFnr: String): String {
    //language=JSON
    return """
        {
          "type": "alder",
