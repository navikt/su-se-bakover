...
class IverksettTilbakekrevingsbehandlingRepoTest(private val dataSource: DataSource) {
    ...
    fun `kan iverksette tilbakekrevingsbehandling`() {
        ...
        val (sak, _, _, _, hendelser) = testDataHelper.tilbakekreving.persisterIverksattTilbakekrevingsbehandlingHendelse()
