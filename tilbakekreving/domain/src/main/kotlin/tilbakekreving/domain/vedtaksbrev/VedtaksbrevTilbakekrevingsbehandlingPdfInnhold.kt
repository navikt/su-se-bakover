...
sealed interface VedtaksbrevTilbakekrevingsbehandlingPdfInnhold : PdfInnhold {
    ...
    companion object {
        fun fromBrevCommand(
            ...
            return when (command) {
                is VedtaksbrevTilbakekrevingsbehandlingDokumentCommand.Vanlig -> Vanlig(
                ...
                is VedtaksbrevTilbakekrevingsbehandlingDokumentCommand.Dødsbo -> Dødsbo(
                    sakstype = command.sakstype,
                    personalia = personalia,
                    saksbehandlerNavn = saksbehandlerNavn,
                    attestantNavn = attestantNavn,
                    ...
                    varselDato = command.forhåndsvarselsDato.toString(),
                )
            }
        }
    }
