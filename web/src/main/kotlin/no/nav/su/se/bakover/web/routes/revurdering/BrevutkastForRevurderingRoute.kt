    ...
    get("$REVURDERING_PATH/{revurderingId}/brevutkast") {
        authorize(Brukerrolle.Saksbehandler) {
            call.withRevurderingId { revurderingId ->
                ...
                val revurdering = revurderingService.hentRevurdering(RevurderingId(revurderingId))
                    ?: return@authorize call.svar(fantIkkeRevurdering)

                revurderingService.lagBrevutkastForRevurdering(RevurderingId(revurderingId)).fold(
