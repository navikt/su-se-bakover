...
internal data class KlageJson(
    ...
    val innenforFristenBegrunnelse: String?,
    val klagesDetPåKonkreteElementerIVedtaket: Boolean?,
    val klagesDetPåKonkreteElementerIVedtaketBegrunnelse: String?,
    val erUnderskrevet: String?,
    val erUnderskrevetBegrunnelse: String?,
    val fremsattRettsligKlageinteresse: String?,
    val fremsattRettsligKlageinteresseBegrunnelse: String?,
...
internal fun Klage.toJson(): KlageJson {
    ...
    return when (this) {
        is OpprettetKlage -> KlageJson(
            ...
            fremsattRettsligKlageinteresseBegrunnelse = null,
            fritekstTilBrev = null,
            vedtaksvurdering = null,
            attesteringer = emptyList(),
            klagevedtakshistorikk = emptyList(),
            avsluttet = avsluttet,
            innenforFristenBegrunnelse = null,
            klagesDetPåKonkreteElementerIVedtaketBegrunnelse = null,
            erUnderskrevetBegrunnelse = null,
        ...
        is VilkårsvurdertKlage.Påbegynt -> KlageJson(
            ...
            innenforFristen = this.vilkårsvurderinger.innenforFristen?.svar?.toString(),
            innenforFristenBegrunnelse = this.vilkårsvurderinger.innenforFristen?.begrunnelse,
            klagesDetPåKonkreteElementerIVedtaket = this.vilkårsvurderinger.klagesDetPåKonkreteElementerIVedtaket?.svar,
            erUnderskrevet = this.vilkårsvurderinger.erUnderskrevet?.svar?.toString(),
            fremsattRettsligKlageinteresse = this.vilkårsvurderinger.fremsattRettsligKlageinteresse?.svar?.toString(),
            fremsattRettsligKlageinteresseBegrunnelse = this.vilkårsvurderinger.fremsattRettsligKlageinteresse?.begrunnelse,
            klagesDetPåKonkreteElementerIVedtaketBegrunnelse = this.vilkårsvurderinger.klagesDetPåKonkreteElementerIVedtaket?.begrunnelse,
            erUnderskrevetBegrunnelse = this.vilkårsvurderinger.erUnderskrevet?.begrunnelse,
            fritekstTilBrev = null,
            vedtaksvurdering = null,
