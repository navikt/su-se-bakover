...
import no.nav.su.se.bakover.domain.søknad.Boforhold.DelerBoligMed
import no.nav.su.se.bakover.domain.søknad.Boforhold.EktefellePartnerSamboer
import no.nav.su.se.bakover.domain.søknad.Boforhold.OppgittAdresse.IngenAdresse.IngenAdresseGrunn
import no.nav.su.se.bakover.domain.søknad.Ektefelle
import no.nav.su.se.bakover.domain.søknad.Flyktningsstatus
import no.nav.su.se.bakover.domain.søknad.ForNav
import no.nav.su.se.bakover.domain.søknad.Formue
import no.nav.su.se.bakover.domain.søknad.InnlagtPåInstitusjon
import no.nav.su.se.bakover.domain.søknad.InntektOgPensjon
import no.nav.su.se.bakover.domain.søknad.Kjøretøy
import no.nav.su.se.bakover.domain.søknad.Oppholdstillatelse
import no.nav.su.se.bakover.domain.søknad.PensjonsOrdningBeløp
import no.nav.su.se.bakover.domain.søknad.Personopplysninger
import no.nav.su.se.bakover.domain.søknad.SøknadInnhold
import no.nav.su.se.bakover.domain.søknad.TrygdeytelseIUtlandet
import no.nav.su.se.bakover.domain.søknad.Uførevedtak
import no.nav.su.se.bakover.domain.søknad.Utenlandsopphold
import no.nav.su.se.bakover.domain.søknad.UtenlandsoppholdPeriode
