...
//        )
        ...
        Tilbakekrevingsjobber(
            ...
            genererDokumentForAvbruttTilbakekrevingsbehandlingKonsument = tilbakekrevingskomponenter.services.genererDokumentForAvbruttTilbakekrevingsbehandlingKonsument,
            initialDelay = initialDelay.next(),
            intervall = Duration.ofSeconds(10),
            runCheckFactory = runCheckFactory,
        ).schedule()
