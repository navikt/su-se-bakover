...
object TestServicesBuilder {
    fun services(
        ...
        sendPåminnelseNyStønadsperiodeService: SendPåminnelseNyStønadsperiodeService = mock(),
    ): Services = Services(
        ...
        sendPåminnelseNyStønadsperiodeService = sendPåminnelseNyStønadsperiodeService,
    )
}
