...
internal object TestBeregning : Beregning {
    ...
    override fun getOpprettet(): Tidspunkt = LocalDateTime.of(2020, Month.AUGUST, 1, 12, 15, 15).toTidspunkt()
    ...
    override fun utledAvslagsgrunner(): List<Avslagsgrunn> = emptyList()
}
