...
class ÅrsakTilManuellReguleringJsonTest {
    ...
    fun `mapper domene-type til json-type`() {
        ...
        årsakDifferanseEtterRegulering.toDbJson() shouldBe """{"type":"DifferanseEtterRegulering","fradragskategori":"Uføretrygd","fradragTilhører":"EPS","begrunnelse":"When in doubt, dont think - simply shout \"For Democracy!\" and charge head-first into your problems.","eksterntBeløpEtterRegulering":"1","forventetBeløpEtterRegulering":"10"}"""
        ...
        årsakMismatch.toDbJson() shouldBe """{"type":"DifferanseFørRegulering","fradragskategori":"Alderspensjon","fradragTilhører":"BRUKER","begrunnelse":"Boy","eksterntBeløpFørRegulering":"1","vårtBeløpFørRegulering":"2"}"""
    }
    ...
    fun `mapper json-type til domene-type`() {
        ...
        deserialize<ÅrsakTilManuellReguleringJson>("""{"type":"DifferanseEtterRegulering","fradragskategori":"Uføretrygd","fradragTilhører":"EPS","begrunnelse":"When in doubt, dont think - simply shout \"For Democracy!\" and charge head-first into your problems.","eksterntBeløpEtterRegulering":"1","forventetBeløpEtterRegulering":"10"}""").toDomain() shouldBe årsakDifferanseEtterRegulering
        ...
        deserialize<ÅrsakTilManuellReguleringJson>("""{"type":"DifferanseFørRegulering","fradragskategori":"Alderspensjon","fradragTilhører":"BRUKER","begrunnelse":"Boy","eksterntBeløpFørRegulering":"1","vårtBeløpFørRegulering":"2"}""").toDomain() shouldBe årsakMismatch
    }

    @Test
    fun `mapper set med domene-type til liste av json-type`() {
        setOf(årsakMismatch).toDbJson() shouldBe """[{"type":"DifferanseFørRegulering","fradragskategori":"Alderspensjon","fradragTilhører":"BRUKER","begrunnelse":"Boy","eksterntBeløpFørRegulering":"1","vårtBeløpFørRegulering":"2"}]"""
