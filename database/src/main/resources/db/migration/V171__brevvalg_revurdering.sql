...
brevvalg as (
	select
		...
		case
            ...
            when revurderingstype like '%IVERKS%INGEN%' and not skalføretilbrevutsending then json_build_object('type','IKKE_SEND_BREV','fritekst',friteksttilbrev,'begrunnelse',null,'bestemtav',saksbehandler)
            when revurderingstype like '%TIL_ATT%INGEN%' and skalføretilbrevutsending then json_build_object('type','SEND_BREV','fritekst',friteksttilbrev,'begrunnelse',null,'bestemtav',saksbehandler)
            ...
            when revurderingstype like '%UNDER%INGEN%' and skalføretilbrevutsending then json_build_object('type','SEND_BREV','fritekst',friteksttilbrev,'begrunnelse',null,'bestemtav',saksbehandler)
            when revurderingstype like '%UNDER%INGEN%' and not skalføretilbrevutsending then json_build_object('type','IKKE_SEND_BREV','fritekst',friteksttilbrev,'begrunnelse',null,'bestemtav',saksbehandler)
            ...
            when revurderingstype like '%UNDER%' and skalføretilbrevutsending then json_build_object('type','SEND_BREV','fritekst',friteksttilbrev,'begrunnelse',null,'bestemtav','srvsupstonad')
