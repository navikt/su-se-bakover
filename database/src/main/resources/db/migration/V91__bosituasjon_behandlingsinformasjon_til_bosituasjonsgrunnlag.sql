with søknadsbehandling_behandlingsinformasjon as ( select
                                                       ...
                                                       case
                                                           ...
                                                           when (ektefelle ->> 'type' = 'IngenEktefelle' AND bosituasjon ->> 'delerBolig' is null) then 'HAR_IKKE_EPS'
...
insert into grunnlag_bosituasjon (id, opprettet, behandlingid, fraogmed, tilogmed, bosituasjontype, eps_fnr, begrunnelse) (
    select uuid_generate_v4(),
           ...
           bosituasjonstype,
           epsFnr,
           begrunnelse from søknadsbehandling_behandlingsinformasjon where bosituasjonstype is not null );
...
insert into grunnlag_bosituasjon (id, opprettet, behandlingid, fraogmed, tilogmed, bosituasjontype, eps_fnr, begrunnelse) (
    select uuid_generate_v4(),
           ...
           bosituasjonstype,
           epsFnr,
           begrunnelse from revurdering_behandlingsinformasjon where bosituasjonstype is not null
);
