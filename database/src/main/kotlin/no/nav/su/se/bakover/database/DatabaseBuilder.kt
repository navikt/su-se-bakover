...
import no.nav.su.se.bakover.database.kontrollsamtale.KontrollsamtaleNotatVedleggPostgresRepo
...
import no.nav.su.se.bakover.database.regulering.EksternReguleringPerioderPostgresRepo
import no.nav.su.se.bakover.database.regulering.ReguleringKjøringFremgangPostgresRepo
...
import no.nav.su.se.bakover.database.regulering.ReguleringStatusUteståendePostgresRepo
...
import no.nav.su.se.bakover.database.statistikk.FritekstAvslagRepoImpl
import no.nav.su.se.bakover.database.statistikk.SakStatistikkRepoImpl
import no.nav.su.se.bakover.database.statistikk.StønadStatistikkRepoImpl
import no.nav.su.se.bakover.database.statistikk.SøknadStatistikkRepoImpl
...
data object DatabaseBuilder {
    ...
    private fun buildInternal(
        ...
        val sakStatistikkRepo = SakStatistikkRepoImpl(
            sessionFactory = sessionFactory,
            dbMetrics = dbMetrics,
        )
        ...
        return DatabaseRepos(
            ...
            notatRepo = NotatRepoImpl(sessionFactory = sessionFactory, dbMetrics = dbMetrics),
            vedleggRepo = VedleggRepoImpl(sessionFactory = sessionFactory, dbMetrics = dbMetrics),
            kontrollsamtaleNotatRepo = KontrollsamtaleNotatPostgresRepo(sessionFactory = sessionFactory, dbMetrics = dbMetrics),
            kontrollsamtaleNotatVedleggRepo = KontrollsamtaleNotatVedleggPostgresRepo(sessionFactory = sessionFactory, dbMetrics = dbMetrics),
