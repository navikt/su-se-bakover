...
import no.nav.su.se.bakover.database.brev.BrevvalgSøknadsbehandlingDbJson
...
private fun Søknadsbehandling.toBase(): BaseSøknadsbehandlingDb {
    return BaseSøknadsbehandlingDb(
        ...
        brevvalgSøknadsbehandling = this.brevvalgSøknadsbehandling,
    )
}
...
internal class SøknadsbehandlingPostgresRepo(
    ...
    private fun lagre(søknadsbehandling: SøknadsbehandlingDb, tx: TransactionalSession) {
        ...
        (
            ...
            params = mapOf(
                ...
                "brevvalg" to serialize(søknadsbehandling.base.brevvalgSøknadsbehandling.toDb()),
    ...
    private fun Row.toSøknadsbehandling(session: Session): Søknadsbehandling {
        ...
        val brevvalg = deserialize<BrevvalgSøknadsbehandlingDbJson>(string("brevvalg")).toDomain()
        ...
        return lagSøknadsbehandling(
            ...
            søknadsbehandlingHistorikk = søknadsbehandlingHistorikk,
            sakstype = sakstype,
            saksbehandler = saksbehandler,
    ...
    private fun lagSøknadsbehandling(
        status: SøknadsbehandlingStatusDB,
        ...
        søknadsbehandlingHistorikk: Søknadsbehandlingshistorikk,
        sakstype: Sakstype,
        saksbehandler: NavIdentBruker.Saksbehandler?,
        omgjøringsårsak: Revurderingsårsak.Årsak?,
        omgjøringsgrunn: Omgjøringsgrunn?,
        brevvalg: BrevvalgSøknadsbehandling,
        ...
        val søknadsbehandling = when (status) {
            ...
            SøknadsbehandlingStatusDB.TIL_ATTESTERING_INNVILGET -> SøknadsbehandlingTilAttestering.Innvilget(
                ...
                omgjøringsårsak = omgjøringsårsak,
                omgjøringsgrunn = omgjøringsgrunn,
                brevvalgSøknadsbehandling = brevvalg as BrevvalgSøknadsbehandling.Valgt,
            )
