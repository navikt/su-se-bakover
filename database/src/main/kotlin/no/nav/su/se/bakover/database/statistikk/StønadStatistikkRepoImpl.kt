    ...
    private fun lagreMånedStatistikk(session: Session, månedStatistikk: StønadstatistikkMåned) {
        """
            INSERT INTO stoenad_maaned_statistikk (
                ...
                offentligPensjon, offentligPensjonEps, omsorgsloenn, omsorgsloennEps,
                privatPensjon, privatPensjonEps, sosialstonad, sosialstonadEps,
        ...
        """.trimIndent()
            .insert(
                mapOf(
                    ...
                    "omsorgsloenn" to månedStatistikk.omsorgslønn,
                    "omsorgsloennEps" to månedStatistikk.omsorgslønnEps,
                ...
                .hentListe(
                    ...
                    with(row) {
                        ...
                        StønadstatistikkMåned(
                            ...
                            omsorgslønn = intOrNull("omsorgsloenn"),
                            omsorgslønnEps = intOrNull("omsorgsloennEps"),
