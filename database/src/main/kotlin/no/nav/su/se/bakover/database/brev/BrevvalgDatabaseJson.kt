...
data class BrevvalgDatabaseJson(
    ...
    companion object {
        fun Brevvalg.toJson() = BrevvalgDatabaseJson(
            ...
            type = when (this) {
                ...
                is Brevvalg.SaksbehandlersValg.SkalSendeBrev.VedtaksbrevUtenFritekst -> Type.SAKSBEHANDLER_VALG_SKAL_SENDE_VEDTAKSBREV_UTEN_FRITEKST
    ...
    fun toDomain(): Brevvalg {
        return when (this.type) {
            ...
            Type.SAKSBEHANDLER_VALG_SKAL_SENDE_VEDTAKSBREV_UTEN_FRITEKST -> Brevvalg.SaksbehandlersValg.SkalSendeBrev.VedtaksbrevUtenFritekst(
                begrunnelse = this.begrunnelse,
            )
