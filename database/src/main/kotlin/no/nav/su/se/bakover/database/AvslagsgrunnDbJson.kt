...
enum class AvslagsgrunnDbJson {
    ...
    ALDERSPENSJON_FOLKETRYGDEN,
    ALDERSPENSJON_ANDRE_NORSKE_PENSJONSORDNINGER,
    ALDERSPENSJON_UTENLANDSKE_PENSJONSORDNINGER,
    FAMILIEGJENFORENING,
}
...
fun Avslagsgrunn.toDbJson(): AvslagsgrunnDbJson {
    return when (this) {
        ...
        Avslagsgrunn.ALDERSPENSJON_FOLKETRYGDEN -> AvslagsgrunnDbJson.ALDERSPENSJON_FOLKETRYGDEN
        Avslagsgrunn.ALDERSPENSJON_ANDRE_NORSKE_PENSJONSORDNINGER -> AvslagsgrunnDbJson.ALDERSPENSJON_ANDRE_NORSKE_PENSJONSORDNINGER
        Avslagsgrunn.ALDERSPENSJON_UTENLANDSKE_PENSJONSORDNINGER -> AvslagsgrunnDbJson.ALDERSPENSJON_UTENLANDSKE_PENSJONSORDNINGER
...
fun AvslagsgrunnDbJson.toDomain(): Avslagsgrunn {
    return when (this) {
        ...
        AvslagsgrunnDbJson.ALDERSPENSJON_FOLKETRYGDEN -> Avslagsgrunn.ALDERSPENSJON_FOLKETRYGDEN
        AvslagsgrunnDbJson.ALDERSPENSJON_ANDRE_NORSKE_PENSJONSORDNINGER -> Avslagsgrunn.ALDERSPENSJON_ANDRE_NORSKE_PENSJONSORDNINGER
        AvslagsgrunnDbJson.ALDERSPENSJON_UTENLANDSKE_PENSJONSORDNINGER -> Avslagsgrunn.ALDERSPENSJON_UTENLANDSKE_PENSJONSORDNINGER
