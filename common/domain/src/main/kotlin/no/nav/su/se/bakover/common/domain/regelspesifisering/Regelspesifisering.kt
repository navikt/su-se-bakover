...
enum class Regelspesifiseringer(
    ...
    REGEL_HISTORISK_INFOTRYGD_SATS("REGEL-HISTORISK-INFOTRYGD-SATS", "1"),
    REGEL_HISTORISK_INFOTRYGD_MINSTEGRENSE("REGEL-HISTORISK-INFOTRYGD-MINSTEGRENSE", "1"),
    REGEL_HISTORISK_INFOTRYGD_MÅNEDSBEREGNING("REGEL-HISTORISK-INFOTRYGD-MÅNEDSBEREGNING", "1"),
    REGEL_HISTORISK_INFOTRYGD_BEREGNING("REGEL-HISTORISK-INFOTRYGD-BEREGNING", "1"),
...
enum class RegelspesifisertGrunnlag(
    ...
    GRUNNLAG_HISTORISK_INFOTRYGD_SATSKATEGORI("GRUNNLAG-HISTORISK-INFOTRYGD-SATSKATEGORI", "1"),
    GRUNNLAG_HISTORISK_INFOTRYGD_SATSVERDI("GRUNNLAG-HISTORISK-INFOTRYGD-SATSVERDI", "1"),
    ...
    fun benyttGrunnlag(
        ...
        kilde: String = when (this) {
            ...
            GRUNNLAG_UFØRETRYGD,
            GRUNNLAG_FORMUE,
            GRUNNLAG_HISTORISK_INFOTRYGD_SATSKATEGORI,
            -> "Saksbehandler"
            ...
            GRUNNLAG_HISTORISK_INFOTRYGD_SATSVERDI,
            -> "SU-App"
        },
