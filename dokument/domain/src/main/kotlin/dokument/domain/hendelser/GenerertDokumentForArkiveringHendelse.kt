 ...
 * Arkivering skjer hos oss.
 */
data class GenerertDokumentForArkiveringHendelse(
    ...
    companion object {
        ...
        ): GenerertDokumentForArkiveringHendelse {
            return GenerertDokumentForArkiveringHendelse(
                hendelseId = hendelseId,
