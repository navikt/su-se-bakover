...
class TestDataHelper(
    ...
    val notatRepo = databaseRepos.notatRepo
    val vedleggRepo = databaseRepos.vedleggRepo
    ...
    fun persisterSakMedSøknadUtenJournalføringOgOppgave(
        ...
        fnr: Fnr = Fnr.generer(),
        søknadInnhold: SøknadInnhold = søknadinnholdUføre(personopplysninger = FnrWrapper(fnr)),
    ...
    fun persisterLukketJournalførtSøknadMedOppgave(
        ...
        søknadInnhold: SøknadsinnholdUføre = søknadinnholdUføre(personopplysninger = FnrWrapper(fnr)),
    ...
    fun persisterReguleringIverksatt(
        ...
        return persisterReguleringOpprettet(
            ...
            beregnetRegulering.tilAttestering(saksbehandler, beregnetRegulering.oppgaveId ?: OppgaveId("oppgaveid"))
