...
fun Klage?.shouldBeEqualComparingPublicFieldsAndInterface(expected: Klage?, ignoreProperty: KProperty<*>? = null) {
    ...
    when (this) {
        ...
        is VurdertKlage.UtfyltBehandlesIVedtaksinstans, is VurdertKlage.UtfyltTilOversending -> this.castAndCompare<VurdertKlageFelter>(expected, ignoreProperty)
        ...
        is VurdertKlage.BekreftetBehandlesIVedtaksinstans -> this.castAndCompare<VurdertKlage.BekreftetBehandlesIVedtaksinstans>(expected)
    }
}
