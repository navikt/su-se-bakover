...
class PdlClientWithCacheTest {
    ...
    fun `Cacher resultat fra pdl på andre kall`() {
        ...
        val spyCache: Cache<FnrCacheKey, PdlData> = newCache(cacheName = "person/domain", suMetrics = mock())
        val pdlClient = org.mockito.kotlin.mock<PdlClient> {
    ...
    fun `Kan cache aktørid`() {
        ...
        val spyCache: Cache<FnrCacheKey, AktørId> = newCache(cacheName = "aktoerId", suMetrics = mock())
        val pdlClient = org.mockito.kotlin.mock<PdlClient> {
