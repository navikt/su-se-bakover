...
enum class Avslagsgrunn(val paragrafer: NonEmptyList<Int>) {
    ...
    ALDERSPENSJON_FOLKETRYGDEN(nonEmptyListOf(6)),
    ALDERSPENSJON_ANDRE_NORSKE_PENSJONSORDNINGER(nonEmptyListOf(6)),
    ALDERSPENSJON_UTENLANDSKE_PENSJONSORDNINGER(nonEmptyListOf(6)),
