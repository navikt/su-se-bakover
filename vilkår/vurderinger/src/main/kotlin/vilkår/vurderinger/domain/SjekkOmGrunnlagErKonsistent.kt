...
import vilkår.bosituasjon.domain.grunnlag.Bosituasjon.Companion.harOverlappende
...
import vilkår.inntekt.domain.grunnlag.Fradragsgrunnlag.Companion.allePerioderMedEPS
import vilkår.inntekt.domain.grunnlag.Fradragsgrunnlag.Companion.perioder
...
data class SjekkOmGrunnlagErKonsistent(
    ...
    private val bosituasjongrunnlag: List<Bosituasjon.Fullstendig>,
    ...
    val resultat: Either<Set<Konsistensproblem>, Unit> = setOf(
        ...
        BosituasjonKonsistensProblem(bosituasjongrunnlag).resultat,
...
data class BosituasjonOgFradrag(
    ...
    private fun bosituasjonOgFradrag(): Either<Set<Konsistensproblem.BosituasjonOgFradrag>, Unit> {
        ...
        mutableSetOf<Konsistensproblem.BosituasjonOgFradrag>().apply {
            BosituasjonKonsistensProblem(bosituasjon).resultat.onLeft {
