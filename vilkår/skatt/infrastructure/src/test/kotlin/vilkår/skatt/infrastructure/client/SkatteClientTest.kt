...
internal class SkatteClientTest {
    ...
    private val fnr = Fnr("21839199217")
    ...
    @Test
    fun `504 med ikke-json body mapper til nettverksfeil`() {
        startedWireMockServerWithCorrelationId {
            stubFor(
                WireMock.post(WireMock.urlPathEqualTo("/api/v2/summertskattegrunnlag"))
                    .willReturn(
            ...
            client(baseUrl()).hentSamletSkattegrunnlag(
                ...
                it.oppgjør.oppslag
                    .onLeft { it.shouldBeInstanceOf<KunneIkkeHenteSkattemelding.Nettverksfeil>() }
    ...
    @Test
    fun `500 mapper til nettverksfeil`() {
        startedWireMockServerWithCorrelationId {
            stubFor(
                WireMock.post(WireMock.urlPathEqualTo("/api/v2/summertskattegrunnlag"))
                    .willReturn(
                        WireMock.aResponse()
                            ...
                            .withStatus(500)
                            .withResponseBody(
                                Body("""{"ske-message":{"kode":"SSG-001","melding":"Uventet feil"}}"""),
                            ),
                    ),
            )
