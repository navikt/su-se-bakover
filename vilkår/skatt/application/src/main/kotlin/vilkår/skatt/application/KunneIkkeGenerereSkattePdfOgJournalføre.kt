...
sealed interface KunneIkkeGenerereSkattePdfOgJournalføre {
    data class FeilVedGenereringAvPdf(val originalFeil: KunneIkkeHenteOgLagePdfAvSkattegrunnlag) : KunneIkkeGenerereSkattePdfOgJournalføre

    data class FeilVedJournalføring(val originalFeil: KunneIkkeJournalføreDokument) : KunneIkkeGenerereSkattePdfOgJournalføre

    data class FeilVedHentingAvSkattemelding(val originalFeil: KunneIkkeHenteSkattemelding) : KunneIkkeGenerereSkattePdfOgJournalføre

    data class FeilVedJournalpostUtenforSak(val originalFeil: KunneIkkeLageJournalpostUtenforSak) : KunneIkkeGenerereSkattePdfOgJournalføre

    data class SakstypeErIkkeDenSammeSomForespurt(val faktiskSakstype: Sakstype, val forespurtSakstype: Sakstype) : KunneIkkeGenerereSkattePdfOgJournalføre
